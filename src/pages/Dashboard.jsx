...
function Dashboard() {
    ...
    const handleAddTask = (e) => {
        ...
        if (formData.title.trim() === '') {
            setFormError('Vul een taaknaam in.');
            return;
        }

        if (formData.vak.trim() === '') {
            setFormError('Vul een vak in.');
            return;
        }

        if (formData.deadline.trim() === '') {
            setFormError('Vul een deadline in.');
            return;
        }
        ...
        const newTaskObject = {
            ...
            omschrijving: formData.omschrijving || 'Nog geen omschrijving',
            docent: formData.docent || 'Onbekend',
            uren: formData.uren || 0,
        };
    ...
    return (
        <div className={darkMode ? 'dark' : ''}>
            ...
            <div>
                ...
                {!loading && !apiError && apiTasks.length === 0 && (
                    <p>Geen voorbeeldtaken gevonden.</p>
                )}
